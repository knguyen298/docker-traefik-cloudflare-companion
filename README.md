...
### Prebuilt Images
This fork builds the image on GitHub Actions and publishes it to the GitHub Container Registry for amd64 and arm64. The upstream images on Docker Hub are no longer available.

```bash
docker pull ghcr.io/knguyen298/traefik-cloudflare-companion:latest
```
